...
@yottadb.transaction
def simple_rollback_transaction(key1:yottadb.Key, value1:bytes, key2:yottadb.Key, value2:bytes, context:yottadb.Context) -> None:
    key1.value = value1
    key2.value = value2
...
@yottadb.transaction
def simple_restart_transaction(key1:yottadb.Key, key2:yottadb.Key, value:bytes, restart_tracker:yottadb.Key, context:yottadb.Context) -> None:
