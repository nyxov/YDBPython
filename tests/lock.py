...
if __name__ == '__main__':
    ...
    parser.add_argument('-T', '--locktimeout', type=int, default=1,
    ...
    has_lock = False
    try:
        _yottadb.lock_incr_st(varname, subsarray_bytes, timeout_nsec=(args.locktimeout * 1_000_000_000))
    ...
    if (has_lock):
        ...
        _yottadb.lock_decr_st(varname, subsarray_bytes)
